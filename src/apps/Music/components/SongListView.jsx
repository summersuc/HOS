    ...
    return (
        ...
        >
            ...
            <div className="relative z-20 -mt-6 bg-[#F5F5F7] dark:bg-black rounded-t-[32px] min-h-[calc(100vh-380px)] shadow-[0_-10px_40px_rgba(0,0,0,0.1)]">
                ...
                <div className="sticky top-[64px] z-30 bg-[#F5F5F7]/95 dark:bg-black/95 backdrop-blur-xl px-4 py-3 flex items-center justify-between border-b border-gray-200/50 dark:border-white/5">

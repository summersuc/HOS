...
const DiscoveryView = memo(({ userId, onSelectPlaylist, onPlaySong, onOpenSearch, setGlobalLoading }) => {
    ...
    return (
        <div className="h-full flex flex-col overflow-y-auto pb-32 bg-[#F5F5F7] dark:bg-black scroll-smooth overscroll-contain" style={{ paddingTop: 'calc(env(safe-area-inset-top) + 67px)' }}>
